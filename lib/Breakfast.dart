...
class Breakfast extends StatefulWidget {
  ...
  const Breakfast({super.key, required this.filter});
...
class _BreakfastState extends State<Breakfast> {
  ...
  String getAppBarTitle() {
    switch (widget.filter) {
      case 'Today':
        return 'Breakfast Consumed Today';
      case 'This Month':
        return 'Breakfast Consumed This Month';
      case 'This Year':
        return 'Breakfast Consumed This Year';
      case 'Overall':
        return 'Breakfast Consumed Overall';
      default:
        return 'Breakfast Log';
    }
  }
      ...
      body: Padding(
        ...
        meals.isEmpty
          ...
          children: [
            const Spacer(),
            const Text(
              "Oops! No breakfast items found. Please try changing the filter and try again.",
              style: TextStyle(
                fontSize: 18,
